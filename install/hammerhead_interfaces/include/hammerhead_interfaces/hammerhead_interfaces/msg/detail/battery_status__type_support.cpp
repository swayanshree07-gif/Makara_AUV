...
{
  new (message_memory) hammerhead_interfaces::msg::BatteryStatus(_init);
}

void BatteryStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::BatteryStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryStatus_message_member_array[3] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::BatteryStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::BatteryStatus, battery1),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::BatteryStatus, battery2),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(hammerhead_interfaces::msg::BatteryStatus),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, BatteryStatus)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
