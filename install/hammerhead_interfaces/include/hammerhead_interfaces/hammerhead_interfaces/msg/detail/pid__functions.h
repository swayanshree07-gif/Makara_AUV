...
#ifndef HAMMERHEAD_INTERFACES__MSG__DETAIL__PID__FUNCTIONS_H_
#define HAMMERHEAD_INTERFACES__MSG__DETAIL__PID__FUNCTIONS_H_
 ...
 * )) before or use
 * hammerhead_interfaces__msg__PID__create()
 ...
 * calls
 * hammerhead_interfaces__msg__PID__init().
...
/**
 * It calls
 * hammerhead_interfaces__msg__PID__fini()
 ...
 * hammerhead_interfaces__msg__PID__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hammerhead_interfaces__msg__PID__Sequence__fini()
 * on the array,
...
#endif  // HAMMERHEAD_INTERFACES__MSG__DETAIL__PID__FUNCTIONS_H_
