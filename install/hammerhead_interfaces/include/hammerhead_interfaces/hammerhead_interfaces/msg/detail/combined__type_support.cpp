...
{
  new (message_memory) hammerhead_interfaces::msg::Combined(_init);
}

void Combined_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::Combined *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Combined_message_member_array[3] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::Combined, angular),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::Combined, linear),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::Combined, depth),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Combined_message_members = {
  ...
  3,  // number of fields
  sizeof(hammerhead_interfaces::msg::Combined),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::Combined_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, Combined)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::Combined_message_type_support_handle;
}
