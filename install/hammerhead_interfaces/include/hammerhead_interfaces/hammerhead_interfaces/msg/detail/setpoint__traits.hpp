...
#ifndef HAMMERHEAD_INTERFACES__MSG__DETAIL__SETPOINT__TRAITS_HPP_
#define HAMMERHEAD_INTERFACES__MSG__DETAIL__SETPOINT__TRAITS_HPP_
...
inline void to_yaml(
  const hammerhead_interfaces::msg::Setpoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hammerhead_interfaces::msg::Setpoint & msg)
{
  return hammerhead_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hammerhead_interfaces::msg::Setpoint>()
{
  return "hammerhead_interfaces::msg::Setpoint";
}

template<>
inline const char * name<hammerhead_interfaces::msg::Setpoint>()
{
  return "hammerhead_interfaces/msg/Setpoint";
}

template<>
struct has_fixed_size<hammerhead_interfaces::msg::Setpoint>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hammerhead_interfaces::msg::Setpoint>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hammerhead_interfaces::msg::Setpoint>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HAMMERHEAD_INTERFACES__MSG__DETAIL__SETPOINT__TRAITS_HPP_
