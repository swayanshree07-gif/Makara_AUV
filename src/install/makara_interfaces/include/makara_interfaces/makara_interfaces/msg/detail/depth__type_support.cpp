...
{
  new (message_memory) makara_interfaces::msg::Depth(_init);
}

void Depth_fini_function(void * message_memory)
{
  auto typed_message = static_cast<makara_interfaces::msg::Depth *>(message_memory);
  typed_message->~Depth();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Depth_message_member_array[2] = {
  {
    ...
    offsetof(makara_interfaces::msg::Depth, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(makara_interfaces::msg::Depth, depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Depth_message_members = {
  ...
  "Depth",  // message name
  2,  // number of fields
  sizeof(makara_interfaces::msg::Depth),
...
{
  return &::makara_interfaces::msg::rosidl_typesupport_introspection_cpp::Depth_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, makara_interfaces, msg, Depth)() {
  return &::makara_interfaces::msg::rosidl_typesupport_introspection_cpp::Depth_message_type_support_handle;
}
