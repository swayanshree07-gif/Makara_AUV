...
#ifndef MAKARA_INTERFACES__MSG__DETAIL__MOVE_CMD__STRUCT_HPP_
#define MAKARA_INTERFACES__MSG__DETAIL__MOVE_CMD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__makara_interfaces__msg__MoveCmd __attribute__((deprecated))
#else
# define DEPRECATED__makara_interfaces__msg__MoveCmd __declspec(deprecated)
#endif
...
struct MoveCmd_
{
  ...
  // pointer types
  using RawPtr =
    makara_interfaces::msg::MoveCmd_<ContainerAllocator> *;
  using ConstRawPtr =
    const makara_interfaces::msg::MoveCmd_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      makara_interfaces::msg::MoveCmd_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__makara_interfaces__msg__MoveCmd
    std::shared_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__makara_interfaces__msg__MoveCmd
    std::shared_ptr<makara_interfaces::msg::MoveCmd_<ContainerAllocator> const>
...
using MoveCmd =
  makara_interfaces::msg::MoveCmd_<std::allocator<void>>;
...
#endif  // MAKARA_INTERFACES__MSG__DETAIL__MOVE_CMD__STRUCT_HPP_
