...
{
  new (message_memory) makara_interfaces::msg::Setpoint(_init);
}

void Setpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<makara_interfaces::msg::Setpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Setpoint_message_member_array[2] = {
  {
    ...
    offsetof(makara_interfaces::msg::Setpoint, setpoints),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(makara_interfaces::msg::Setpoint, joy),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Setpoint_message_members = {
  ...
  2,  // number of fields
  sizeof(makara_interfaces::msg::Setpoint),
...
{
  return &::makara_interfaces::msg::rosidl_typesupport_introspection_cpp::Setpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, makara_interfaces, msg, Setpoint)() {
  return &::makara_interfaces::msg::rosidl_typesupport_introspection_cpp::Setpoint_message_type_support_handle;
}
