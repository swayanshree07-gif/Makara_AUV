...
#ifndef MAKARA_INTERFACES__MSG__DETAIL__PID__TRAITS_HPP_
#define MAKARA_INTERFACES__MSG__DETAIL__PID__TRAITS_HPP_
...
inline void to_yaml(
  const makara_interfaces::msg::PID & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const makara_interfaces::msg::PID & msg)
{
  return makara_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<makara_interfaces::msg::PID>()
{
  return "makara_interfaces::msg::PID";
}

template<>
inline const char * name<makara_interfaces::msg::PID>()
{
  return "makara_interfaces/msg/PID";
}

template<>
struct has_fixed_size<makara_interfaces::msg::PID>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<makara_interfaces::msg::PID>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<makara_interfaces::msg::PID>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MAKARA_INTERFACES__MSG__DETAIL__PID__TRAITS_HPP_
