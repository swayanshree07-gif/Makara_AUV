...
#include "makara_interfaces/msg/detail/move_cmds__rosidl_typesupport_fastrtps_c.h"
...
#include "makara_interfaces/msg/detail/move_cmd__functions.h"  // list
...
using _MoveCmds__ros_msg_type = makara_interfaces__msg__MoveCmds;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_makara_interfaces__msg__MoveCmds(
  const makara_interfaces__msg__MoveCmds * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: len
  {
  ...
  // Field name: list
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_makara_interfaces__msg__MoveCmd(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_deserialize_makara_interfaces__msg__MoveCmds(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces__msg__MoveCmds * ros_message)
{
  // Field name: len
  {
    cdr >> ros_message->len;
  ...
  // Field name: list
  {
    ...
    if (ros_message->list.data) {
      makara_interfaces__msg__MoveCmd__Sequence__fini(&ros_message->list);
    }
    if (!makara_interfaces__msg__MoveCmd__Sequence__init(&ros_message->list, size)) {
      fprintf(stderr, "failed to create array for field 'list'");
      return false;
    }
    auto array_ptr = ros_message->list.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_makara_interfaces__msg__MoveCmd(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_makara_interfaces__msg__MoveCmds(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_makara_interfaces__msg__MoveCmd(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_makara_interfaces__msg__MoveCmds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_makara_interfaces__msg__MoveCmd(
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces__msg__MoveCmds;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_key_makara_interfaces__msg__MoveCmds(
  const makara_interfaces__msg__MoveCmds * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: len
  ...
  // Field name: list
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_makara_interfaces__msg__MoveCmd(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_key_makara_interfaces__msg__MoveCmds(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveCmds__ros_msg_type * ros_message = static_cast<const _MoveCmds__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: list
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_makara_interfaces__msg__MoveCmd(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_key_makara_interfaces__msg__MoveCmds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_makara_interfaces__msg__MoveCmd(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const makara_interfaces__msg__MoveCmds * ros_message = static_cast<const makara_interfaces__msg__MoveCmds *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_makara_interfaces__msg__MoveCmds(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  makara_interfaces__msg__MoveCmds * ros_message = static_cast<makara_interfaces__msg__MoveCmds *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_makara_interfaces__msg__MoveCmds(cdr, ros_message);
}

static uint32_t _MoveCmds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_makara_interfaces__msg__MoveCmds(
...
static size_t _MoveCmds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_makara_interfaces__msg__MoveCmds(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, makara_interfaces, msg, MoveCmds)() {
