...
#include "makara_interfaces/msg/detail/vector_nav_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const makara_interfaces::msg::VectorNavData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces::msg::VectorNavData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces::msg::VectorNavData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const makara_interfaces::msg::VectorNavData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<makara_interfaces::msg::VectorNavData *>(
    untyped_ros_message);
...
{
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_VectorNavData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, makara_interfaces, msg, VectorNavData)() {
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_VectorNavData__handle;
}
