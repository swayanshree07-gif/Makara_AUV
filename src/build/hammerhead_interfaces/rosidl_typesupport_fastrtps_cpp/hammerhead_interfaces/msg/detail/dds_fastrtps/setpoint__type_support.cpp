...
#include "hammerhead_interfaces/msg/detail/setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hammerhead_interfaces::msg::Setpoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hammerhead_interfaces::msg::Setpoint & ros_message)
{
  // Member: setpoints
  {
    cdr >> ros_message.setpoints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::Setpoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::Setpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::Setpoint *>(
    untyped_ros_message);
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Setpoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hammerhead_interfaces, msg, Setpoint)() {
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Setpoint__handle;
}
