...
#include "hammerhead_interfaces/msg/detail/combined__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::Combined;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::Combined *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::Combined *>(
    untyped_ros_message);
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Combined__handle;
}
