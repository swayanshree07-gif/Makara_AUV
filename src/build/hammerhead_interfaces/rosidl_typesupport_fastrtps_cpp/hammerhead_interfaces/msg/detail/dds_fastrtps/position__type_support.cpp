...
#include "hammerhead_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
