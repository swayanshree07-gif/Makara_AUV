...
#include "hammerhead_interfaces/msg/detail/thruster_speeds__rosidl_typesupport_fastrtps_c.h"
...
using _ThrusterSpeeds__ros_msg_type = hammerhead_interfaces__msg__ThrusterSpeeds;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces__msg__ThrusterSpeeds;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hammerhead_interfaces__msg__ThrusterSpeeds * ros_message = static_cast<const hammerhead_interfaces__msg__ThrusterSpeeds *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hammerhead_interfaces__msg__ThrusterSpeeds(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hammerhead_interfaces__msg__ThrusterSpeeds * ros_message = static_cast<hammerhead_interfaces__msg__ThrusterSpeeds *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hammerhead_interfaces__msg__ThrusterSpeeds(cdr, ros_message);
}

static uint32_t _ThrusterSpeeds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hammerhead_interfaces__msg__ThrusterSpeeds(
...
static size_t _ThrusterSpeeds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hammerhead_interfaces__msg__ThrusterSpeeds(
