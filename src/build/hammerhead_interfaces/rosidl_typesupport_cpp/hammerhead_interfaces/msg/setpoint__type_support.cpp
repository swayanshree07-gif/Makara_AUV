...
static const _Setpoint_type_support_symbol_names_t _Setpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hammerhead_interfaces, msg, Setpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, Setpoint)),
  }
};
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_cpp::Setpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hammerhead_interfaces, msg, Setpoint)() {
  return get_message_type_support_handle<hammerhead_interfaces::msg::Setpoint>();
}
