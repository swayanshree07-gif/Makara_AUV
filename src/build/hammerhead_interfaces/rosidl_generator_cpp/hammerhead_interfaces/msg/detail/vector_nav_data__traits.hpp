...
#ifndef HAMMERHEAD_INTERFACES__MSG__DETAIL__VECTOR_NAV_DATA__TRAITS_HPP_
#define HAMMERHEAD_INTERFACES__MSG__DETAIL__VECTOR_NAV_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const hammerhead_interfaces::msg::VectorNavData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hammerhead_interfaces::msg::VectorNavData & msg)
{
  return hammerhead_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hammerhead_interfaces::msg::VectorNavData>()
{
  return "hammerhead_interfaces::msg::VectorNavData";
}

template<>
inline const char * name<hammerhead_interfaces::msg::VectorNavData>()
{
  return "hammerhead_interfaces/msg/VectorNavData";
}

template<>
struct has_fixed_size<hammerhead_interfaces::msg::VectorNavData>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hammerhead_interfaces::msg::VectorNavData>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hammerhead_interfaces::msg::VectorNavData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HAMMERHEAD_INTERFACES__MSG__DETAIL__VECTOR_NAV_DATA__TRAITS_HPP_
