...
#include "hammerhead_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_c.h"
...
using _PID__ros_msg_type = hammerhead_interfaces__msg__PID;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces__msg__PID;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hammerhead_interfaces__msg__PID * ros_message = static_cast<const hammerhead_interfaces__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hammerhead_interfaces__msg__PID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hammerhead_interfaces__msg__PID * ros_message = static_cast<hammerhead_interfaces__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hammerhead_interfaces__msg__PID(cdr, ros_message);
}

static uint32_t _PID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hammerhead_interfaces__msg__PID(
...
static size_t _PID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hammerhead_interfaces__msg__PID(
