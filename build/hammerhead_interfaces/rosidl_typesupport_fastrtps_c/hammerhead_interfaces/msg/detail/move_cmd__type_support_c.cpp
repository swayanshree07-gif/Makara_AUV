...
#include "hammerhead_interfaces/msg/detail/move_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _MoveCmd__ros_msg_type = hammerhead_interfaces__msg__MoveCmd;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces__msg__MoveCmd;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hammerhead_interfaces__msg__MoveCmd * ros_message = static_cast<const hammerhead_interfaces__msg__MoveCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hammerhead_interfaces__msg__MoveCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hammerhead_interfaces__msg__MoveCmd * ros_message = static_cast<hammerhead_interfaces__msg__MoveCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hammerhead_interfaces__msg__MoveCmd(cdr, ros_message);
}

static uint32_t _MoveCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hammerhead_interfaces__msg__MoveCmd(
...
static size_t _MoveCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hammerhead_interfaces__msg__MoveCmd(
