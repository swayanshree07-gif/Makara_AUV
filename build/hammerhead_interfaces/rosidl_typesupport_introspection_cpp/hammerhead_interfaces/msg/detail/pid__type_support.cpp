...
{
  new (message_memory) hammerhead_interfaces::msg::PID(_init);
}

void PID_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::PID *>(message_memory);
  typed_message->~PID();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PID_message_member_array[3] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::PID, kp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::PID, ki),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::PID, kd),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PID_message_members = {
  ...
  "PID",  // message name
  3,  // number of fields
  sizeof(hammerhead_interfaces::msg::PID),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::PID_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, PID)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::PID_message_type_support_handle;
}
