...
{
  new (message_memory) hammerhead_interfaces::msg::InsVel(_init);
}

void InsVel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::InsVel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InsVel_message_member_array[1] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::InsVel, vel),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers InsVel_message_members = {
  ...
  "InsVel",  // message name
  1,  // number of fields
  sizeof(hammerhead_interfaces::msg::InsVel),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::InsVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, InsVel)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::InsVel_message_type_support_handle;
}
