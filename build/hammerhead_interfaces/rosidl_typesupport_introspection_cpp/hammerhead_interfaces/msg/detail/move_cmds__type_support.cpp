...
{
  new (message_memory) hammerhead_interfaces::msg::MoveCmds(_init);
}

void MoveCmds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::MoveCmds *>(message_memory);
  typed_message->~MoveCmds();
}

size_t size_function__MoveCmds__list(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<hammerhead_interfaces::msg::MoveCmd> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<hammerhead_interfaces::msg::MoveCmd> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<hammerhead_interfaces::msg::MoveCmd> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const hammerhead_interfaces::msg::MoveCmd *>(
    get_const_function__MoveCmds__list(untyped_member, index));
  auto & value = *reinterpret_cast<hammerhead_interfaces::msg::MoveCmd *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<hammerhead_interfaces::msg::MoveCmd *>(
    get_function__MoveCmds__list(untyped_member, index));
  const auto & value = *reinterpret_cast<const hammerhead_interfaces::msg::MoveCmd *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveCmds_message_member_array[2] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::MoveCmds, len),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<hammerhead_interfaces::msg::MoveCmd>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::MoveCmds, list),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveCmds_message_members = {
  ...
  2,  // number of fields
  sizeof(hammerhead_interfaces::msg::MoveCmds),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::MoveCmds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, MoveCmds)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::MoveCmds_message_type_support_handle;
}
