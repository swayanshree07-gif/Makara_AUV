...
{
  new (message_memory) hammerhead_interfaces::msg::ThrusterSpeeds(_init);
}

void ThrusterSpeeds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hammerhead_interfaces::msg::ThrusterSpeeds *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ThrusterSpeeds_message_member_array[2] = {
  {
    ...
    offsetof(hammerhead_interfaces::msg::ThrusterSpeeds, data),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hammerhead_interfaces::msg::ThrusterSpeeds, reverse),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ThrusterSpeeds_message_members = {
  ...
  2,  // number of fields
  sizeof(hammerhead_interfaces::msg::ThrusterSpeeds),
...
{
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::ThrusterSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hammerhead_interfaces, msg, ThrusterSpeeds)() {
  return &::hammerhead_interfaces::msg::rosidl_typesupport_introspection_cpp::ThrusterSpeeds_message_type_support_handle;
}
