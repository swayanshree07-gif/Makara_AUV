...
bool hammerhead_interfaces__msg__move_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hammerhead_interfaces.msg._move_cmd.MoveCmd", full_classname_dest, 43) == 0);
  }
  hammerhead_interfaces__msg__MoveCmd * ros_message = _ros_message;
  {  // surge
...
PyObject * hammerhead_interfaces__msg__move_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hammerhead_interfaces.msg._move_cmd");
