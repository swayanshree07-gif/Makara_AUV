...
#include "hammerhead_interfaces/msg/detail/vector_nav_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hammerhead_interfaces::msg::VectorNavData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hammerhead_interfaces::msg::VectorNavData & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hammerhead_interfaces
max_serialized_size_VectorNavData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::VectorNavData;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hammerhead_interfaces
max_serialized_size_key_VectorNavData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::VectorNavData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::VectorNavData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VectorNavData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::VectorNavData *>(
...
static size_t _VectorNavData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VectorNavData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VectorNavData__callbacks = {
...
static rosidl_message_type_support_t _VectorNavData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VectorNavData__callbacks,
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_VectorNavData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hammerhead_interfaces, msg, VectorNavData)() {
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_VectorNavData__handle;
}
