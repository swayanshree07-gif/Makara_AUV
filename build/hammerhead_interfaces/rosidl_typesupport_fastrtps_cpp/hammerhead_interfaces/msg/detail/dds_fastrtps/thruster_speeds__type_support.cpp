...
#include "hammerhead_interfaces/msg/detail/thruster_speeds__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hammerhead_interfaces::msg::ThrusterSpeeds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hammerhead_interfaces::msg::ThrusterSpeeds & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  // Member: reverse
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.reverse[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hammerhead_interfaces
max_serialized_size_ThrusterSpeeds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::ThrusterSpeeds;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hammerhead_interfaces
max_serialized_size_key_ThrusterSpeeds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::ThrusterSpeeds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::ThrusterSpeeds *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ThrusterSpeeds__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::ThrusterSpeeds *>(
...
static size_t _ThrusterSpeeds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ThrusterSpeeds(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ThrusterSpeeds__callbacks = {
...
static rosidl_message_type_support_t _ThrusterSpeeds__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ThrusterSpeeds__callbacks,
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_ThrusterSpeeds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hammerhead_interfaces, msg, ThrusterSpeeds)() {
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_ThrusterSpeeds__handle;
}
