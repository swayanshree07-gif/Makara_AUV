...
#include "hammerhead_interfaces/msg/detail/depth__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hammerhead_interfaces::msg::Depth & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hammerhead_interfaces::msg::Depth & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hammerhead_interfaces::msg::Depth;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hammerhead_interfaces::msg::Depth *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hammerhead_interfaces::msg::Depth *>(
    untyped_ros_message);
...
{
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Depth__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hammerhead_interfaces, msg, Depth)() {
  return &hammerhead_interfaces::msg::typesupport_fastrtps_cpp::_Depth__handle;
}
