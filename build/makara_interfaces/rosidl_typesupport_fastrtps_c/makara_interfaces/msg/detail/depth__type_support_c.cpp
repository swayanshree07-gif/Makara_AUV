...
#include "makara_interfaces/msg/detail/depth__rosidl_typesupport_fastrtps_c.h"
...
using _Depth__ros_msg_type = makara_interfaces__msg__Depth;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces__msg__Depth;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const makara_interfaces__msg__Depth * ros_message = static_cast<const makara_interfaces__msg__Depth *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_makara_interfaces__msg__Depth(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  makara_interfaces__msg__Depth * ros_message = static_cast<makara_interfaces__msg__Depth *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_makara_interfaces__msg__Depth(cdr, ros_message);
}

static uint32_t _Depth__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_makara_interfaces__msg__Depth(
...
static size_t _Depth__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_makara_interfaces__msg__Depth(
