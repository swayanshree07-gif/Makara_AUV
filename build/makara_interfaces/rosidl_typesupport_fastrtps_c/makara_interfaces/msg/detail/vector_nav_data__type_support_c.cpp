...
#include "makara_interfaces/msg/detail/vector_nav_data__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_makara_interfaces
...
using _VectorNavData__ros_msg_type = makara_interfaces__msg__VectorNavData;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_makara_interfaces__msg__VectorNavData(
  const makara_interfaces__msg__VectorNavData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_deserialize_makara_interfaces__msg__VectorNavData(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces__msg__VectorNavData * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_makara_interfaces__msg__VectorNavData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_makara_interfaces__msg__VectorNavData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces__msg__VectorNavData;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_key_makara_interfaces__msg__VectorNavData(
  const makara_interfaces__msg__VectorNavData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_key_makara_interfaces__msg__VectorNavData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VectorNavData__ros_msg_type * ros_message = static_cast<const _VectorNavData__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_key_makara_interfaces__msg__VectorNavData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const makara_interfaces__msg__VectorNavData * ros_message = static_cast<const makara_interfaces__msg__VectorNavData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_makara_interfaces__msg__VectorNavData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  makara_interfaces__msg__VectorNavData * ros_message = static_cast<makara_interfaces__msg__VectorNavData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_makara_interfaces__msg__VectorNavData(cdr, ros_message);
}

static uint32_t _VectorNavData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_makara_interfaces__msg__VectorNavData(
...
static size_t _VectorNavData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_makara_interfaces__msg__VectorNavData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, makara_interfaces, msg, VectorNavData)() {
