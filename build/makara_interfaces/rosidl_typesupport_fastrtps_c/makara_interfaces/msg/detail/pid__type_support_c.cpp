...
#include "makara_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_c.h"
...
using _PID__ros_msg_type = makara_interfaces__msg__PID;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_makara_interfaces__msg__PID(
  const makara_interfaces__msg__PID * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_deserialize_makara_interfaces__msg__PID(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces__msg__PID * ros_message)
{
  // Field name: kp
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_makara_interfaces__msg__PID(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_makara_interfaces__msg__PID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces__msg__PID;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
bool cdr_serialize_key_makara_interfaces__msg__PID(
  const makara_interfaces__msg__PID * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: kp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t get_serialized_size_key_makara_interfaces__msg__PID(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PID__ros_msg_type * ros_message = static_cast<const _PID__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_makara_interfaces
size_t max_serialized_size_key_makara_interfaces__msg__PID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const makara_interfaces__msg__PID * ros_message = static_cast<const makara_interfaces__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_makara_interfaces__msg__PID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  makara_interfaces__msg__PID * ros_message = static_cast<makara_interfaces__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_makara_interfaces__msg__PID(cdr, ros_message);
}

static uint32_t _PID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_makara_interfaces__msg__PID(
...
static size_t _PID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_makara_interfaces__msg__PID(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, makara_interfaces, msg, PID)() {
