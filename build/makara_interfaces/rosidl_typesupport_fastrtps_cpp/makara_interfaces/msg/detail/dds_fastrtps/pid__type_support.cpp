...
#include "makara_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces::msg::PID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const makara_interfaces::msg::PID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<makara_interfaces::msg::PID *>(
    untyped_ros_message);
...
{
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_PID__handle;
}
