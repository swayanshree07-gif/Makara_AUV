...
#include "makara_interfaces/msg/detail/ins_vel__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces::msg::InsVel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const makara_interfaces::msg::InsVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<makara_interfaces::msg::InsVel *>(
    untyped_ros_message);
...
{
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_InsVel__handle;
}
