...
#include "makara_interfaces/msg/detail/thruster_speeds__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const makara_interfaces::msg::ThrusterSpeeds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces::msg::ThrusterSpeeds & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces::msg::ThrusterSpeeds;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const makara_interfaces::msg::ThrusterSpeeds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<makara_interfaces::msg::ThrusterSpeeds *>(
    untyped_ros_message);
...
{
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_ThrusterSpeeds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, makara_interfaces, msg, ThrusterSpeeds)() {
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_ThrusterSpeeds__handle;
}
