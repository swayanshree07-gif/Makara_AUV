...
#include "makara_interfaces/msg/detail/move_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const makara_interfaces::msg::MoveCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  makara_interfaces::msg::MoveCmd & ros_message)
{
  // Member: surge
  cdr >> ros_message.surge;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = makara_interfaces::msg::MoveCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const makara_interfaces::msg::MoveCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<makara_interfaces::msg::MoveCmd *>(
    untyped_ros_message);
...
{
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_MoveCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, makara_interfaces, msg, MoveCmd)() {
  return &makara_interfaces::msg::typesupport_fastrtps_cpp::_MoveCmd__handle;
}
