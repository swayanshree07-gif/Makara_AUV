...
static const _ThrusterSpeeds_type_support_symbol_names_t _ThrusterSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, makara_interfaces, msg, ThrusterSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, makara_interfaces, msg, ThrusterSpeeds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, makara_interfaces, msg, ThrusterSpeeds)() {
  return &::makara_interfaces::msg::rosidl_typesupport_c::ThrusterSpeeds_message_type_support_handle;
}
